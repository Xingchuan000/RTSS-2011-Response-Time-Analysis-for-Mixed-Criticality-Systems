...
def build_dummy_variables() -> dict[str, float | bool]:
    ...
    return {
        ...
        "delta_lo_released_jobs": 5.0,
        "delta_lo_finalized_jobs": 5.0,
        "delta_lo_service_quality_sum": 3.5,
        "delta_lo_equiv_jne": 1.5,
        "delta_lo_zero_service_jobs": 1.0,
        "delta_lo_partial_service_jobs": 2.0,
        "lo_service_quality_per_finalized_job": 0.7,
        "lo_equiv_jne_per_finalized_job": 0.3,
        "cumulative_lo_service_quality_sum": 70.0,
        "cumulative_lo_equiv_jne": 30.0,
        "cumulative_lo_finalized_jobs": 100.0,
