        ...
        if isinstance(env_values, dict):
            for name, value in env_values.items():
                if name in records or name in {"agent_period", "action_space", "observation_mode",
                                                ...
                                                "nonvacuity_profile", "nonvacuity_enabled",
                                                "nonvacuity_disabled_guards", "budget_rounding_mode",
                                                "min_budget_delta", "nonvacuity_deadline_cleanup_remove",
                                                "nonvacuity_hi_budget_cap_truncate",
                                                "nonvacuity_arrival_before_deadline",
                                                "nonvacuity_recover_without_quiescence",
                                                "nonvacuity_unstable_demand_reads", "processor_overhead",
