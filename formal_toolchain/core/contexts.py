...
OBLIGATION_CONTEXT_LAYERS: dict[str, str] = {
    ...
    "PROTECTED_PREFIX_REFERENCE_MODEL_CONFORMANCE": "terminal_route_context",
    ...
    "FULL_REFERENCE_RECURRING_INPUT_ORACLE": "terminal_route_context",
    "PROTECTED_INPUT_STREAM_PROJECTION": "terminal_route_context",
    "PROTECTED_INPUT_DEMAND_RECEPTIVENESS": "terminal_route_context",
    "PPP_L1_TAIL_SERVICE_EXCLUSION": "terminal_route_context",
    "PPP_L2_FINAL_DISPATCH_CORRESPONDENCE": "terminal_route_context",
    "PPP_L3_SERVICE_CORRESPONDENCE": "terminal_route_context",
    "PPP_L4_COMPLETION_REMOVAL_CORRESPONDENCE": "terminal_route_context",
    "PPP_L5_DEADLINE_BATCH_FOLD": "terminal_route_context",
    "PPP_L6_ARRIVAL_BATCH_FOLD": "terminal_route_context",
    "PPP_L7_CANONICAL_PHASE_JOIN": "terminal_route_context",
    "PROTECTED_MACRO_STEP_PRESERVATION": "terminal_route_context",
    "PROTECTED_PREFIX_REFERENCE_PREFIX_EXTENSION": "terminal_route_context",
    "PROTECTED_PREFIX_CANONICAL_SUCCESSOR_TOTAL": "terminal_route_context",
    "PROTECTED_PREFIX_SAME_TIME_CLOSURE_TERMINATES": "terminal_route_context",
    "PROTECTED_PREFIX_TIME_DIVERGENCE": "terminal_route_context",
    "PROTECTED_PREFIX_IDLE_JUMP_STUTTER_EXPANSION": "terminal_route_context",
    "PROTECTED_PREFIX_COMPLETE_EXECUTION_EXISTS": "terminal_route_context",
    "PROTECTED_PREFIX_INITIAL_RELATION": "terminal_route_context",
    # bridge
...
# V8 raw protected-prefix obligations are all terminal-route scoped.  Keeping
# this list explicit preserves the fail-closed rule for genuinely unknown IDs.
for _raw_terminal_id in (
    ...
    "RAW_PREFIX_EXECUTION_EXISTENCE_CONFORMANCE", "RAW_PREFIX_MATHEMATICAL_CONFORMANCE",
    ...
    "RAW_PREFIX_COMPLETE_EXECUTION_EXISTENCE", "RAW_PREFIX_WEAK_FORWARD_SIMULATION_DERIVED",
    "N4_REFERENCE_ROUTE_BOUNDARY_ALIGNMENT", "RAW_PREFIX_HI_BAD_PREFIX_REFLECTION",
    "RAW_PREFIX_ALL_TASK_RTA_ARITHMETIC", "RAW_PREFIX_VERIFIER_SOUNDNESS",
    "RAW_PREFIX_INSTANCE_EVIDENCE_BINDING", "RAW_PREFIX_TASKSET_SCHEDULABLE",
    "REFERENCE_HI_SAFETY_FROM_RAW_PREFIX",
):
    OBLIGATION_CONTEXT_LAYERS[_raw_terminal_id] = "terminal_route_context"
