...
def bind_action_runtime(source_root: Path, *, action_space_type: str = "single",
    ...
    names = ("build_budget_action_space", "apply_budget_action_candidate", "AmcBudgetEnv.valid_action_mask",
             "AmcBudgetEnv.step", "AmcBudgetEnv._budget_floor_violation", "AmcBudgetEnv._deploy_cap_increase_reject_reason")
    functions = {}
    for name in names:
    ...
    canonical_tokens = (
        ...
        "valid_action_mask", "apply_budget_action_candidate",
    )
    ...
    shared_index = exact_indexing and "valid_action_mask" in source and "self._actions" in source
    if missing_tokens or not shared_index:
    ...
    return {"status": "PASS", "action_space_type": action_space_type, "action_dim": action_dim,
            ...
            "order_evidence": {"source": "derived_from_canonical_action_source", "verified": exact_indexing,
                                ...
                                "mask_and_step_share_action_index": shared_index,
