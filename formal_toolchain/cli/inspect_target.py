"""V9.1 request/tree preflight CLI."""
...
from formal_toolchain.v9_1.bindings import build_bindings


def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="inspect a V9.1 proof request or integer-tree artifact")
