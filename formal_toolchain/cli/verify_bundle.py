"""V9.2 fresh-process verifier CLI."""
...
from formal_toolchain.v9_2.verifier import verify_bundle_v9_2
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="independently verify a V9.2 candidate proof bundle")
    ...
    try:
        ...
        print(json.dumps({"workflow_status": "FAILED", "result_status": RESULT_INVALID,
                          "failure_route": RESULT_INVALID, "failure_code": "V9_2_VERIFIER_INPUT_ERROR",
