"""Print machine-readable readiness of the single V9.1 proof route."""
...
from formal_toolchain.v9_1.constants import PROOF_ROUTE
...
def readiness_report() -> dict[str, object]:
    ...
    return {
        "schema_version": "v9_1_proof_readiness_v1",
