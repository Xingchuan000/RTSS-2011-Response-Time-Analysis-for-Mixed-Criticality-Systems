...
def resolve_registry(route: ProofRoute | str) -> ResolvedRegistry:
    ...
    if route_id not in {"strict_full", "protected_prefix", "raw_protected_prefix"}:
    ...
    selected_source = (
        "REFERENCE_HI_SUBSET_SAFETY" if route_id == "strict_full" else
        "REFERENCE_HI_SAFETY_FROM_PROTECTED_PREFIX" if route_id == "protected_prefix" else
        "REFERENCE_HI_SAFETY_FROM_RAW_PREFIX"
    )
    selected = _template(terminal_source, "SELECTED_REFERENCE_HI_SAFETY",
                         depends_on=[selected_source])
    common_ids = {
    ...
    if route_id == "strict_full":
    ...
    elif route_id == "protected_prefix":
        prefix_ids = [
            ...
            "PROTECTED_PREFIX_WEAK_FORWARD_SIMULATION_DERIVED", "N4_REFERENCE_ROUTE_BOUNDARY_ALIGNMENT",
            "PROTECTED_PREFIX_HI_BAD_PREFIX_REFLECTION", "REFERENCE_HI_SAFETY_FROM_PROTECTED_PREFIX",
        ]
        ...
        by["N4_REFERENCE_ROUTE_BOUNDARY_ALIGNMENT"]["depends_on"] = [
        ...
        by["PROTECTED_PREFIX_HI_BAD_PREFIX_REFLECTION"]["depends_on"] = [
            ...
            "PPP_L5_DEADLINE_BATCH_FOLD", "N4_REFERENCE_ROUTE_BOUNDARY_ALIGNMENT",
        ]
        ...
        raw_ids = [
            ...
            "RAW_PREFIX_PARAMETER_INHERITANCE",
            "RAW_PREFIX_NO_SATURATION_BINDING",
            "RAW_PREFIX_TAIL_PURE_LO",
            "RAW_PREFIX_PRIORITY_CLOSURE",
            "RAW_PREFIX_JOB_KEY_BINDING",
            "RAW_FULL_PREFIX_RUNTIME_SCHEMA_CONFORMANCE",
            "RAW_PREFIX_RELEASE_FIXED_POSITIVE_DEMAND",
            "RAW_PREFIX_PROTECTED_INPUT_RECEPTIVENESS",
            "RAW_PREFIX_PROTECTED_INPUT_INDEPENDENCE",
            "RAW_PREFIX_MODE_TRANSPARENT_LIFECYCLE",
            "RAW_PREFIX_IDLE_ONLY_RECOVERY",
            "RAW_PREFIX_ABNORMAL_HI_ONLY_SWITCH",
            "RAW_PREFIX_FIXED_PROCESSOR_SUPPLY",
            ...
            "RAW_PREFIX_VERIFIER_SOUNDNESS",
            "RAW_PREFIX_INSTANCE_EVIDENCE_BINDING",
            "RAW_PREFIX_MATHEMATICAL_CONFORMANCE",
            "RAW_PREFIX_TASKSET_SCHEDULABLE",
            "REFERENCE_HI_SAFETY_FROM_RAW_PREFIX",
        ]
        rta_deps = list(source["ALL_TASK_REFERENCE_RTA_ARITHMETIC"]["depends_on"])
        route = [_template(terminal_source, item, depends_on=[],
                           producer_id=item.lower() + "_v8") for item in raw_ids]
        by = {item["id"]: item for item in route}
        by["RAW_PREFIX_PARAMETER_INHERITANCE"]["depends_on"] = ["RAW_PROTECTED_PRIORITY_PREFIX_PARTITION"]
        by["RAW_PREFIX_NO_SATURATION_BINDING"]["depends_on"] = ["RAW_PREFIX_PARAMETER_INHERITANCE"]
        by["RAW_PREFIX_TAIL_PURE_LO"]["depends_on"] = ["RAW_PROTECTED_PRIORITY_PREFIX_PARTITION"]
        by["RAW_PREFIX_PRIORITY_CLOSURE"]["depends_on"] = ["RAW_PROTECTED_PRIORITY_PREFIX_PARTITION"]
        by["RAW_PREFIX_JOB_KEY_BINDING"]["depends_on"] = ["RAW_PREFIX_PARAMETER_INHERITANCE"]
        by["RAW_FULL_PREFIX_RUNTIME_SCHEMA_CONFORMANCE"]["depends_on"] = [
            "RAW_PREFIX_PARAMETER_INHERITANCE", "RAW_PREFIX_TAIL_PURE_LO",
            "RAW_PREFIX_PRIORITY_CLOSURE",
        ]
        for oid in (
            "RAW_PREFIX_RELEASE_FIXED_POSITIVE_DEMAND",
            ...
            by[oid]["depends_on"] = ["RAW_FULL_PREFIX_RUNTIME_SCHEMA_CONFORMANCE"]
        by["RAW_PREFIX_PROTECTED_INPUT_RECEPTIVENESS"]["depends_on"] = [
            "RAW_FULL_PREFIX_RUNTIME_SCHEMA_CONFORMANCE",
            "RAW_PREFIX_PARAMETER_INHERITANCE", "RAW_PREFIX_JOB_KEY_BINDING",
        ]
        by["RAW_PREFIX_FULL_IDLE_IMPLIES_RAW_IDLE"]["depends_on"] = [
            "RAW_PREFIX_PRIORITY_CLOSURE", "RAW_PREFIX_TAIL_PURE_LO",
            "RAW_PREFIX_FIXED_PROCESSOR_SUPPLY", "RAW_FULL_PREFIX_RUNTIME_SCHEMA_CONFORMANCE",
        ]
        by["RAW_PREFIX_RECOVERY_ORDER_PRESERVATION"]["depends_on"] = [
            "RAW_PREFIX_FULL_IDLE_IMPLIES_RAW_IDLE", "RAW_PREFIX_IDLE_ONLY_RECOVERY",
            "RAW_FULL_PREFIX_RUNTIME_SCHEMA_CONFORMANCE",
        ]
        by["RAW_PREFIX_SWITCH_ORDER_PRESERVATION"]["depends_on"] = [
            "RAW_PREFIX_ABNORMAL_HI_ONLY_SWITCH", "RAW_PREFIX_TAIL_PURE_LO",
            "RAW_PREFIX_PROTECTED_INPUT_INDEPENDENCE", "RAW_FULL_PREFIX_RUNTIME_SCHEMA_CONFORMANCE",
        ]
        by["RAW_PREFIX_MODE_ORDER_INVARIANT"]["depends_on"] = [
            "RAW_PREFIX_RECOVERY_ORDER_PRESERVATION", "RAW_PREFIX_SWITCH_ORDER_PRESERVATION",
            "RAW_FULL_PREFIX_RUNTIME_SCHEMA_CONFORMANCE",
        ]
        by["RAW_PREFIX_ADMISSIBLE_SET_DOMINATION"]["depends_on"] = [
            "RAW_PREFIX_MODE_ORDER_INVARIANT", "RAW_PREFIX_PARAMETER_INHERITANCE",
            "RAW_PREFIX_NO_SATURATION_BINDING",
        ]
        by["RAW_PREFIX_RELEASE_DEMAND_RECEPTIVENESS"]["depends_on"] = [
            "RAW_PREFIX_ADMISSIBLE_SET_DOMINATION", "RAW_PREFIX_PROTECTED_INPUT_RECEPTIVENESS",
            "RAW_PREFIX_RELEASE_FIXED_POSITIVE_DEMAND", "RAW_PREFIX_MODE_ORDER_INVARIANT",
        ]
        by["RAW_PREFIX_PROTECTED_ARRIVAL_BATCH_PROJECTION"]["depends_on"] = [
            "RAW_PREFIX_RELEASE_DEMAND_RECEPTIVENESS", "RAW_PREFIX_SWITCH_ORDER_PRESERVATION",
            "RAW_PREFIX_JOB_KEY_BINDING",
        ]
        by["RAW_PREFIX_SERVICE_CORRESPONDENCE"]["depends_on"] = [
            "RAW_PREFIX_PRIORITY_CLOSURE", "RAW_PREFIX_FIXED_PROCESSOR_SUPPLY",
            "RAW_PREFIX_FULL_IDLE_IMPLIES_RAW_IDLE",
        ]
        by["RAW_PREFIX_COMPLETION_CORRESPONDENCE"]["depends_on"] = [
            "RAW_PREFIX_SERVICE_CORRESPONDENCE", "RAW_PREFIX_RELEASE_DEMAND_RECEPTIVENESS",
            "RAW_PREFIX_MODE_TRANSPARENT_LIFECYCLE",
        ]
        by["RAW_PREFIX_DEADLINE_BATCH_CORRESPONDENCE"]["depends_on"] = [
            "RAW_PREFIX_COMPLETION_CORRESPONDENCE", "RAW_FULL_PREFIX_RUNTIME_SCHEMA_CONFORMANCE",
        ]
        by["RAW_PREFIX_TOTAL_FINAL_DISPATCH_CORRESPONDENCE"]["depends_on"] = [
            "RAW_PREFIX_SERVICE_CORRESPONDENCE", "RAW_PREFIX_PRIORITY_CLOSURE",
        ]
        by["RAW_PREFIX_CLOSE_TO_CLOSE_MACROSTEP"]["depends_on"] = [
            "RAW_PREFIX_RECOVERY_ORDER_PRESERVATION", "RAW_PREFIX_SWITCH_ORDER_PRESERVATION",
        ...
        by["RAW_PREFIX_EXECUTION_EXISTENCE_CONFORMANCE"]["depends_on"] = [
            "RAW_FULL_PREFIX_RUNTIME_SCHEMA_CONFORMANCE", "RAW_PREFIX_PROTECTED_INPUT_RECEPTIVENESS",
            "RAW_PREFIX_RELEASE_FIXED_POSITIVE_DEMAND",
        ]
        by["RAW_PREFIX_COMPLETE_EXECUTION_EXISTENCE"]["depends_on"] = [
            "RAW_PREFIX_CLOSE_TO_CLOSE_MACROSTEP", "RAW_PREFIX_EXECUTION_EXISTENCE_CONFORMANCE",
            "RAW_PREFIX_RELEASE_DEMAND_RECEPTIVENESS", "RAW_PREFIX_MODE_ORDER_INVARIANT",
        ]
        by["RAW_PREFIX_WEAK_FORWARD_SIMULATION_DERIVED"]["depends_on"] = [
            "REFERENCE_MODEL_CONFORMANCE", "RAW_PREFIX_EXECUTION_EXISTENCE_CONFORMANCE",
            "RAW_PREFIX_COMPLETE_EXECUTION_EXISTENCE", "RAW_PREFIX_CLOSE_TO_CLOSE_MACROSTEP",
            "RAW_PREFIX_MODE_ORDER_INVARIANT", "RAW_PREFIX_PROTECTED_ARRIVAL_BATCH_PROJECTION",
        ]
        by["N4_REFERENCE_ROUTE_BOUNDARY_ALIGNMENT"]["depends_on"] = [
            "CONTROLLER_BOUNDARY", "RAW_FULL_PREFIX_RUNTIME_SCHEMA_CONFORMANCE",
        ]
        by["RAW_PREFIX_HI_BAD_PREFIX_REFLECTION"]["depends_on"] = [
            "RAW_PREFIX_WEAK_FORWARD_SIMULATION_DERIVED",
            "RAW_PREFIX_DEADLINE_BATCH_CORRESPONDENCE", "RAW_PROTECTED_PRIORITY_PREFIX_PARTITION",
            "N4_REFERENCE_ROUTE_BOUNDARY_ALIGNMENT",
        ]
        by["RAW_PREFIX_ALL_TASK_RTA_ARITHMETIC"]["depends_on"] = [
            "RAW_PREFIX_PARAMETER_INHERITANCE", *rta_deps,
        ]
        by["RAW_PREFIX_VERIFIER_SOUNDNESS"]["depends_on"] = ["RAW_PREFIX_ALL_TASK_RTA_ARITHMETIC"]
        by["RAW_PREFIX_INSTANCE_EVIDENCE_BINDING"]["depends_on"] = [
        ...
        by["RAW_PREFIX_MATHEMATICAL_CONFORMANCE"]["depends_on"] = [
        ...
        by["RAW_PREFIX_TASKSET_SCHEDULABLE"]["depends_on"] = [
        ...
        by["REFERENCE_HI_SAFETY_FROM_RAW_PREFIX"]["depends_on"] = [
            "RAW_PREFIX_HI_BAD_PREFIX_REFLECTION", "RAW_PREFIX_TASKSET_SCHEDULABLE",
        ]
        route = [by[item] for item in raw_ids] + [selected]
    ...
    common_source_excluded = {
        ...
        "RAW_PROTECTED_PRIORITY_PREFIX_PARTITION", "RAW_PREFIX_PARAMETER_INHERITANCE",
        "RAW_PREFIX_NO_SATURATION_BINDING", "RAW_PREFIX_TAIL_PURE_LO",
        "RAW_PREFIX_PRIORITY_CLOSURE", "RAW_PREFIX_JOB_KEY_BINDING",
        "RAW_FULL_PREFIX_RUNTIME_SCHEMA_CONFORMANCE", "RAW_PREFIX_RELEASE_FIXED_POSITIVE_DEMAND",
        "RAW_PREFIX_PROTECTED_INPUT_RECEPTIVENESS", "RAW_PREFIX_PROTECTED_INPUT_INDEPENDENCE",
        "RAW_PREFIX_MODE_TRANSPARENT_LIFECYCLE", "RAW_PREFIX_IDLE_ONLY_RECOVERY",
        "RAW_PREFIX_ABNORMAL_HI_ONLY_SWITCH", "RAW_PREFIX_FIXED_PROCESSOR_SUPPLY",
        "RAW_PREFIX_FULL_IDLE_IMPLIES_RAW_IDLE", "RAW_PREFIX_RECOVERY_ORDER_PRESERVATION",
        "RAW_PREFIX_SWITCH_ORDER_PRESERVATION", "RAW_PREFIX_MODE_ORDER_INVARIANT",
        "RAW_PREFIX_ADMISSIBLE_SET_DOMINATION", "RAW_PREFIX_RELEASE_DEMAND_RECEPTIVENESS",
        "RAW_PREFIX_PROTECTED_ARRIVAL_BATCH_PROJECTION", "RAW_PREFIX_SERVICE_CORRESPONDENCE",
        "RAW_PREFIX_COMPLETION_CORRESPONDENCE", "RAW_PREFIX_DEADLINE_BATCH_CORRESPONDENCE",
        "RAW_PREFIX_TOTAL_FINAL_DISPATCH_CORRESPONDENCE", "RAW_PREFIX_CLOSE_TO_CLOSE_MACROSTEP",
        "RAW_PREFIX_EXECUTION_EXISTENCE_CONFORMANCE", "RAW_PREFIX_COMPLETE_EXECUTION_EXISTENCE",
        "RAW_PREFIX_WEAK_FORWARD_SIMULATION_DERIVED", "N4_REFERENCE_ROUTE_BOUNDARY_ALIGNMENT",
        "RAW_PREFIX_HI_BAD_PREFIX_REFLECTION", "RAW_PREFIX_ALL_TASK_RTA_ARITHMETIC", "RAW_PREFIX_VERIFIER_SOUNDNESS",
        "RAW_PREFIX_INSTANCE_EVIDENCE_BINDING", "RAW_PREFIX_MATHEMATICAL_CONFORMANCE",
        "RAW_PREFIX_TASKSET_SCHEDULABLE", "REFERENCE_HI_SAFETY_FROM_RAW_PREFIX",
