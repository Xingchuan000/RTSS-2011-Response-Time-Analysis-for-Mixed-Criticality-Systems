...
EVENT_TERMINAL_OBLIGATIONS = (
    ...
    "EVENT_ROOT_LINEAR_PHASE_EQUIVALENCE",
    "EVENT_DIRECT_DISPATCH_CASE_EQUIVALENCE",
...
def _structural_claims() -> list[dict[str, Any]]:
    ...
    rows = (
        ...
        ("EVENT_ROOT_LINEAR_PHASE_EQUIVALENCE", "EUCLIDEAN_QUOTIENT_FORM_OF_PHASE_ZERO_PERIODIC_ETA"),
        ("EVENT_DIRECT_DISPATCH_CASE_EQUIVALENCE", "FIXED_PRIORITY_WINNER_CONDITIONS_SPECIALIZED_WITHOUT_GENERIC_MUX"),
