...
def reachable_carry_in_consistency(
    ...
    """V9.3 SafePrefix carry-in refinement.
    ...
    This is intentional: V9.3 does not invent a finite backlog bound where none
    has been proved.  Target-specific Event solving only benefits from protected
