...
def build_runtime_config_for_semantics(
    *,
    ...
    return RuntimeConfig(
        ...
        nonvacuity_deadline_cleanup_remove=nonvacuity_deadline_cleanup_remove,
        nonvacuity_hi_budget_cap_truncate=nonvacuity_hi_budget_cap_truncate,
        nonvacuity_arrival_before_deadline=nonvacuity_arrival_before_deadline,
        nonvacuity_controller_overhead_ticks=nonvacuity_controller_overhead_ticks,
        nonvacuity_recover_without_quiescence=nonvacuity_recover_without_quiescence,
        nonvacuity_unstable_demand_reads=nonvacuity_unstable_demand_reads,
    )
...
def build_env_from_experiment_config(
    ...
    *,
    ...
    policy_selection_semantics: str = "ranked_first_valid",
    ...
    return AmcBudgetEnv(
        ...
        policy_selection_semantics=policy_selection_semantics,
        step_guard_semantics=step_guard_semantics,
        nonvacuity_profile=nonvacuity_profile,
        nonvacuity_disabled_guards=tuple(nonvacuity_disabled_guards),
        budget_rounding_mode=budget_rounding_mode,
