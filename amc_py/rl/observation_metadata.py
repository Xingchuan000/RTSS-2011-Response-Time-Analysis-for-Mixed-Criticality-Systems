        ...
        definitions.append(
            {
                ...
                "increase_ratio_num": int(action.increase_ratio_num),
                "increase_ratio_den": int(action.increase_ratio_den),
                "decrease_ratio_num": int(action.decrease_ratio_num),
                "decrease_ratio_den": int(action.decrease_ratio_den),
